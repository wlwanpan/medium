...
class HelloWorldServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Hello = channel.unary_unary(
                '/service.HelloWorldService/Hello',
...
def add_HelloWorldServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'service.HelloWorldService', rpc_method_handlers)
...
class HelloWorldService(object):
    ...
    def Hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/service.HelloWorldService/Hello',
